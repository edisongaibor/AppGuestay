...
import 'package:flutter_hotel_booking_ui/modules/promo/pantalla_introduccion.dart';
import 'package:flutter_hotel_booking_ui/modules/promo/pantalla_promo.dart';
...
// when this application open every time on that time we check and update some theme data
  ...
  Map<String, WidgetBuilder> _buildRoutes() {
    return {
      ...
      RoutesName.PagoScreen: (BuildContext context) => SplashScreen(),
