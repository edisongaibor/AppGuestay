...
import 'package:flutter_hotel_booking_ui/modules/reserva_hotel/components/map_and_list_view.dart';
import 'package:flutter_hotel_booking_ui/modules/reserva_hotel/components/time_date_view.dart';
import 'package:flutter_hotel_booking_ui/modules/favoritos/vista_lista_hotel.dart';
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Expanded(
            child: Center(
              child: Text(
                AppLocalizations(context).of("explorar"),
