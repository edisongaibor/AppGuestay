...
import 'package:flutter_hotel_booking_ui/modules/explorar/pantalla_inicio_explorar.dart';
import 'package:flutter_hotel_booking_ui/modules/favoritos/pantalla_favoritos.dart';
          ...
          Row(
            children: <Widget>[
              TabButtonUI(
                ...
                text: AppLocalizations(context).of("explorar"),
                onTap: () {
